  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        calm: "bg-calm text-calm-foreground shadow-sm hover:bg-calm/90 hover:shadow-md",
        peace: "bg-peace text-peace-foreground shadow-sm hover:bg-peace/90 hover:shadow-md",
        hope: "bg-hope text-hope-foreground shadow-sm hover:bg-hope/90 hover:shadow-md",
        warmth: "bg-warmth text-warmth-foreground shadow-sm hover:bg-warmth/90 hover:shadow-md",
        support: "bg-support text-support-foreground shadow-sm hover:bg-support/90 hover:shadow-md",
        crisis: "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90 hover:shadow-md",
      },
      size: {
